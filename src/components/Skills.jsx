...
const Skills = () => {
  return (
    <div>
      ...
      <div className=" md:p-24 border border-gray-600 bg-black text-gray-400 md:h-[150px] max-w-[1200px] mx-auto grid grid-cols-5 place-items-center md:flex md:justify-between md:items-center">
